    ...
    <div class="col-md-4">
        <div class="panel panel-default">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <th><?php
                        if (0 == $MESSAGE['GIFT_TYPE']) {
                            echo '邮件_银锭';
                        } else if (1 == $MESSAGE['GIFT_TYPE']) {
                            echo '邮件_金锭';
                        } else if (2 == $MESSAGE['GIFT_TYPE']) {
                            echo '邮件_体力';
                        } else {
                            echo $MESSAGE['GIFT_TYPE'];
                        }
                    ?></th>
                    <td><?php echo $MESSAGE['AMOUNT'].'个' ?></td>
                </tr>
                <?php endforeach; ?>
                </tbody>
            </table>
    ...
    <div class="col-md-8">
        <div role="panel">
            <ul class="nav nav-tabs nav-justified" role="tablist">
                ...
                <li role="presentation"><a href="#achievement" aria-controls="achievement" role="tab" data-toggle="tab">
                Achievement <span class="badge"><?php echo number_format(count($ACHIEVEMENT_ROWS)); ?></span></a></li>
                <li role="presentation"><a href="#mails" aria-controls="mails" role="tab" data-toggle="tab">Mails</a></li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane in" id="mails">
                    <table class="table table-hover table-bordered">
                        <col width="140" />
                        <col width="140" />
                        <col />
                        ...
                        <tr>
                            ...
                            <th class="text-center">物品个数</th>
                            <th class="text-center">发送邮件</th>
                        </tr>
                        </thead>

                        <tbody>
                        <?php echo form_open(site_url(array('user', 'execSendMailCash', $USER_ID)), array('method' => 'post', 'name' => 'add-money-form', 'class' => 'reason-form')); ?>
                        <tr>
                            <td class="text-center">金锭补偿</td>
                            <td class="text-center">金锭</td>                           
                            <td class="text-center">
                                <input type="number" name="amount" class="form-control input-sm" required="required" />
                            </td>
                            <td class="text-center">
                        ...
                        <?php echo form_open(site_url(array('user', 'execSendMailMoney', $USER_ID)), array('method' => 'post', 'name' => 'add-money-form', 'class' => 'reason-form')); ?>
                        <tr>
                            <td class="text-center">银锭补偿</td>
                            <td class="text-center">银锭</td>   
                            <td class="text-center">
                                <input type="number" name="amount" class="form-control input-sm" required="required" />
                            </td>
                            <td class="text-center">
                        ...
                        <?php echo form_open(site_url(array('user', 'execSendMailHeart', $USER_ID)), array('method' => 'post', 'name' => 'add-money-form', 'class' => 'reason-form')); ?>
                        <tr>
                            <td class="text-center">体力补偿</td>
                            <td class="text-center">体力</td>                           
                            <td class="text-center">
                                <input type="number" name="amount" class="form-control input-sm" required="required" />
                            </td>
                            <td class="text-center">
