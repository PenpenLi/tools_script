...
function NPC:changeHpEffect(damageVal,effectType)
    ...
    if  self.npcBook.boss == 1 then
        factor = math.abs(1.0/self:getScaleX())
    end
...
function NPC:initM(cmd)
    ...
    if  self.npcBook.boss == 1  then
        self.hpSlider:setScale(0.8*1.2/self.npcBook.scaleFactor/bossScale)
        self.shieldSlider:setScale(0.8*1.2/self.npcBook.scaleFactor/bossScale)
    end
