...
function TiejiangpuUI:create(data)
...
function TiejiangpuUI:processGuard()
    ...
    if guardCenter:canEnterGuardMode("qianghua") == true then
        ...
        if cmd.name == "qianghua_click_dazhaobtn" then
            cmd.clickTarget = self.dazhaobtn1
            addGuardClickLayer(cmd)
        elseif cmd.name == "qianghua_click_qianghuabtn" then
            cmd.clickTarget = self.m_qhbtn2
            addGuardClickLayer(cmd)
        elseif cmd.name == "qianghua_click_returnbtn" then
            cmd.clickTarget = self.m_returnBtn
            addGuardClickLayer(cmd)
        elseif cmd.name == "qianghua_click_closebtn" then
    ...
    if guardCenter:canEnterGuardMode("jinjie") == true then
        ...
        printJSON(cmd)
        if cmd == nil then return end
        if cmd.name == "jinjie_click_dazaobtn" then
            cmd.clickTarget = self.dazhaobtn1
            addGuardClickLayer(cmd)
        elseif cmd.name == "jinjie_click_jinjiebtn" then
            cmd.clickTarget = self.m_tipBtn3
            addGuardClickLayer(cmd)
        elseif cmd.name == "jinjie_click_jinjiebtn2" then
            cmd.clickTarget = self.m_jjbtn
            addGuardClickLayer(cmd)
       --[[ elseif cmd.name == "jinjie_click_returnbtn" then
            cmd.clickTarget = self.m_returnBtn
            addGuardClickLayer(cmd)
        elseif cmd.name == "jinjie_click_closebtn" then
            cmd.clickTarget = self.m_closebtn
            addGuardClickLayer(cmd)--]]
        end
    end
...
function TiejiangpuUI:initM(data)
...
--	self.m_jjPanel:addTouchEventListener(touchEventHandler)
	...
	self.m_tipBtn3:setAnchorPoint(0.5,0.5)
	self.m_tipBtn3:setPosition(62,190)
    ...
    --self.m_qhbtn2:getParent():setAnchorPoint(0.5,0.5)
	--self.m_qhbtn2:setAnchorPoint(0.5,0.5)
...
function TiejiangpuUI:handleTouchEvent(sender, event)
	...
	elseif sender == self.m_tipBtn0 and event == cc.EventCode.ENDED then
        ...
        Http:req("PrepareStreng",{bagId = self.qhbagid},function(res)
            self.m_tipBtn3:setTitleColor(cc.c3b(255,255,255))
            self.m_tipBtn0:setTitleColor(cc.c3b(92,33,1))
	...
	elseif sender == self.m_tipBtn3 and event == cc.EventCode.ENDED then
		cclog("[TiejiangpuUI]--m_tipBtn3 touched--here")
		
        Http:req("PrepareEquipmentAdvance",{bagId = self.qhbagid},function(res)
            self.m_tipBtn0:setTitleColor(cc.c3b(255,255,255))
            self.m_tipBtn3:setTitleColor(cc.c3b(92,33,1))
	...
	elseif sender == self.m_topBtn3 and event == cc.EventCode.ENDED then
        ...
        self.m_topBtn0:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn1:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn2:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn3:setTitleColor(cc.c3b(92,33,1))
	...
	elseif sender == self.m_topBtn2 and event == cc.EventCode.ENDED then
        ...
        self.m_topBtn0:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn1:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn2:setTitleColor(cc.c3b(92,33,1))
        self.m_topBtn3:setTitleColor(cc.c3b(255,255,255))
	...
	elseif sender == self.m_topBtn1 and event == cc.EventCode.ENDED then
        ...
        self.m_topBtn0:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn1:setTitleColor(cc.c3b(92,33,1))
        self.m_topBtn2:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn3:setTitleColor(cc.c3b(255,255,255))
	...
	elseif sender == self.m_topBtn0 and event == cc.EventCode.ENDED then
        ...
        self.m_topBtn0:setTitleColor(cc.c3b(92,33,1))
        self.m_topBtn1:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn2:setTitleColor(cc.c3b(255,255,255))
        self.m_topBtn3:setTitleColor(cc.c3b(255,255,255))
...
function TiejiangpuUI:Updatelist()
    ...
    for i = 1,table.getn(EquipmentList) do
        ...
        if i==1 then self.dazhaobtn1 = btn end
        ...
        local function EquipmentMenuCallBack(sender, event)
            if sender == btn and event == cc.EventCode.ENDED then
                ...
                if sender == self.dazhaobtn1 then
                    if guardCenter:canEnterGuardMode("qianghua") == true or 
                        guardCenter:canEnterGuardMode("jinjie") == true then
                        removeGuardLayer()
...
function TiejiangpuUI:refreshListUI()
    Http:req("AllEquipmentList",nil,function(list)
        ...
        if self.listtype == 0 then
            self:handleTouchEvent(self.m_topBtn0, cc.EventCode.ENDED)
        elseif self.listtype == 1 then
            self:handleTouchEvent(self.m_topBtn1, cc.EventCode.ENDED)
        elseif self.listtype == 2 then
            self:handleTouchEvent(self.m_topBtn2, cc.EventCode.ENDED)
        elseif self.listtype == 3 then
            self:handleTouchEvent(self.m_topBtn3, cc.EventCode.ENDED)
        end
    end)
end

--init your ui here
function TiejiangpuUI:initUI(list)
    self.weaponInList = list.data["weaponInListInfo"]
    self.clothInList = list.data["clothInListInfo"]
    self.headInList = list.data["headInListInfo"]
    self.accessoryList = list.data["accessoryListInfo"]
