...
void main()
{
    ...
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[0])*0.2;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[1])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[2])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[3])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[4])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[5])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[6])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[7])*0.1;
    gl_FragColor += texture2D(CC_Texture0, v_blurTexCoords[8])*0.1;
    //##vec4(0.0);
